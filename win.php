...
$stmt = $conn->prepare("UPDATE hangman SET score = ? WHERE user_id = ?");
...
<div class="hcontainer">
    <p  style="font-size: 24px; letter-spacing: 3px; margin: 20px 0;">YOU GUESSED IT RIGHT. CONGRATS!</p>
    <p style="font-size: 22px; letter-spacing: 3px; margin: 20px 0;">The word is indeed <?php echo $_SESSION['word']; ?></p>
    <p><img src="win.jpg"></p>
    <p  style="font-size: 24px; letter-spacing: 3px; margin: 20px 0;">PLAY AGAIN!!!!</p>
    <a class="btn btn-logout" href="reset.php">PLAYAGAIN</a>
</div>
